...
//
//
//public class RegistrarPedidoMDB implements MessageListener, ExceptionListener 
//{
...
//		sendMessage(mapper.writeValueAsString(pedido), REQUEST, globalTopic, id);
...
//		ListaPedidosConexion res = new ListaPedidosConexion(answer);
//        return res;
//	}
//	
//	
...
//					PedidoConexion pedidoTemp = mapper.readValue(ex.getPayload(), PedidoConexion.class);
//					if(pedidoTemp.getGrupo1())
//					{
//						List<PedidoConexion> pedidosConexion = new ArrayList<PedidoConexion>();
//						ListaPedidosConexion respuestaPositiva = new ListaPedidosConexion(pedidosConexion);
//						try
//						{
//							respuestaPositiva = dtm.registrarPedidoLocal(pedidoTemp);
//						}
//						catch(Exception e)
//						{
//							System.out.println("error");
//						}
//						String payload = mapper.writeValueAsString(respuestaPositiva);
...
//					{
//						List<PedidoConexion> pedidosConexion = new ArrayList<PedidoConexion>();
//						ListaPedidosConexion respuestaNegativa = new ListaPedidosConexion(pedidosConexion);
//						String payload = mapper.writeValueAsString(respuestaNegativa);
//						Topic t = new RMQDestination("", "videos.test", ex.getRoutingKey(), "", false);
//						sendMessage(payload, REQUEST_ANSWER, t, id);
//					}
//					
...
//				{
//					ListaPedidosConexion v = mapper.readValue(ex.getPayload(), ListaPedidosConexion.class);
//					answer.addAll(v.getPedidosConexion());
//				}
//			}
//			
